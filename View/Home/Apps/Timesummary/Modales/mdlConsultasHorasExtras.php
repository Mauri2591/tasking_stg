<div class="modal fade" id="mdlHorasExtrasTimesummary" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">

            <div class="modal-header bg-light py-2">
                <span class="fs-12 badge bg-primary text-light" id="titulo_mes_hs_extras">Horas Extras Cargadas en el Mes</span>
