$(document).ready(function () {
    tabla = $("#table_proyectos_nuevos_platforms_architecture").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_abiertos_platforms_architecture").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_realizados_platforms_architecture").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
...
function cambiar_estado_proy_desde_calidad_a_borrador(id_proyecto_gestionado) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                $('#table_proyectos_nuevos_platforms_architecture').DataTable().ajax.reload(null, false);
...
function cambiar_estado_proy_desde_calidad_a_abierto(id_proyecto_gestionado) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                $('#table_proyectos_nuevos_platforms_architecture').DataTable().ajax.reload(null, false);
                $('#table_proyectos_abiertos_platforms_architecture').DataTable().ajax.reload(null, false);
            }, 500);
...
function cerrar_proyecto(id_proyecto_gestionado) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#table_proyectos_realizados_platforms_architecture')) {
                    $('#table_proyectos_realizados_platforms_architecture').DataTable().ajax.reload(null, false);
                }
            }, 500);
