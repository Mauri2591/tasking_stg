$(document).ready(function () {
    tabla = $("#table_proyectos_consulting_consultoriaOt_nuevos").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_consulting_consultoriaOt_abiertos").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_consulting_consultoriaOt_realizados").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_consulting_consultoriaOt_cerrados").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
...
function cambiar_proy_consulting_producto1(id_proyecto_gestionado) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#table_proyectos_consulting_consultoriaOt_nuevos')) {
                    $('#table_proyectos_consulting_consultoriaOt_nuevos').DataTable().ajax.reload(null, false);
                }
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                ...
                if ($.fn.DataTable.isDataTable('#table_proyectos_consulting_consultoriaOt_abiertos')) {
                    $('#table_proyectos_consulting_consultoriaOt_abiertos').DataTable().ajax.reload(null, false);
                }
            }, 500);
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.post("../../../../../../Controller/ctrProyectos.php?proy=update_estado_proy", {
                ...
                function (data) {
                    console.log(data); // 👈 para ver respuesta del servidor
                    Swal.fire({
                        icon: "success",
                        title: "Bien",
                        text: "Proyecto pasado a Nuevo!",
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#table_proyectos_consulting_consultoriaOt_nuevos')) {
                    $('#table_proyectos_consulting_consultoriaOt_abiertos').DataTable().ajax.reload(null, false);
                    $('#table_proyectos_consulting_consultoriaOt_realizados').DataTable().ajax.reload(null, false);
                }
            }, 500);
        }
    })
