$(document).ready(function () {
    tabla = $("#table_proyectos_calidad_Procesos").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_abiertos_calidad_Procesos").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_realizados_calidad_Procesos").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_cerrados_calidad_Procesos").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                ...
                if ($.fn.DataTable.isDataTable('#table_proyectos_abiertos_calidad_Procesos')) {
                    $('#table_proyectos_abiertos_calidad_Procesos').DataTable().ajax.reload(null, false);
                }
                if ($.fn.DataTable.isDataTable('#table_proyectos_calidad_Procesos')) {
                    $('#table_proyectos_calidad_Procesos').DataTable().ajax.reload(null, false);
                }
            }, 500);
            Swal.fire({
                icon: "success",
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                ...
                if ($.fn.DataTable.isDataTable('#table_proyectos_realizados_calidad_Procesos')) {
                    $('#table_proyectos_realizados_calidad_Procesos').DataTable().ajax.reload(null, false);
                }
            }, 500);
