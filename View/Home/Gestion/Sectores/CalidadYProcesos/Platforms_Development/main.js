$(document).ready(function () {
    tabla = $("#table_proyectos_calidad_Platforms_Development").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
        ...
        "ajax": {
            ...
            data: {
                sector_id: 4, // calidad
                estados_id: 1, //nuevos
                cat_id: 64 //Platforms_Development
            },
            error: function (e) {
            }
        },
    ...
    tabla = $("#table_proyectos_abiertos_calidad_Platforms_Development").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_realizados_calidad_Platforms_Development").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_cerrados_calidad_Platforms_Development").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                ...
                if ($.fn.DataTable.isDataTable('#table_proyectos_abiertos_calidad_Platforms_Development')) {
                    $('#table_proyectos_abiertos_calidad_Platforms_Development').DataTable().ajax.reload(null, false);
                }
                if ($.fn.DataTable.isDataTable('#table_proyectos_calidad_Platforms_Development')) {
                    $('#table_proyectos_calidad_Platforms_Development').DataTable().ajax.reload(null, false);
                }
            }, 500);
            Swal.fire({
                icon: "success",
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                ...
                if ($.fn.DataTable.isDataTable('#table_proyectos_realizados_calidad_Platforms_Development')) {
                    $('#table_proyectos_realizados_calidad_Platforms_Development').DataTable().ajax.reload(null, false);
                }
            }, 500);
