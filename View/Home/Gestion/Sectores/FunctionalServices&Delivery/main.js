$(document).ready(function () {
    tabla = $("#table_proyectos_nuevos_functional_services").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
...
function cambiar_estado_proy_desde_calidad_a_borrador(id_proyecto_gestionado) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                $('#table_proyectos_nuevos_functional_services').DataTable().ajax.reload(null, false);
...
function cerrar_proyecto(id_proyecto_gestionado) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#table_proyectos_realizados_functional_services')) {
