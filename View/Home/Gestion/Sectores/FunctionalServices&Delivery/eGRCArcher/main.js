$(document).ready(function () {
    tabla = $("#table_proyectos_nuevos_funcional_services").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
        ...
        "ajax": {
            url: "../../../../../../Controller/ctrProyectos.php?proy=get_proyectos_functional_services_y_delivery",
            type: "post",
            dataType: "json",
            data: {
                sector_id: 7,
    ...
    tabla = $("#table_proyectos_abiertos_functional_services").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_realizados_functional_services").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_cerrado_calidad_eh_pentest").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
...
function cambiar_proy_eh_pentest(id_proyecto_gestionado) {
    Swal.fire({
        icon: "info",
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#table_proyectos_nuevos_funcional_services')) {
                    $('#table_proyectos_nuevos_funcional_services').DataTable().ajax.reload(null, false);
                }
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                ...
                if ($.fn.DataTable.isDataTable('#table_proyectos_abiertos_functional_services')) {
                    $('#table_proyectos_abiertos_functional_services').DataTable().ajax.reload(null, false);
                }
            }, 500);
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#table_proyectos_nuevos_funcional_services')) {
                    $('#table_proyectos_abiertos_functional_services').DataTable().ajax.reload(null, false);
                    $('#table_proyectos_realizados_functional_services').DataTable().ajax.reload(null, false);
                }
            }, 500);
        }
    })
