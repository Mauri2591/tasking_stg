            ...
            <div class="row">
                <div class="col-12">
                     <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-light">
                        <h4 class="mb-sm-0"><span class="badge" style='background-color:#8F6B32; color:#FFF;'>FUNCTIONAL SERVICES</span><span class="badge mx-1" style='background-color:#8F6B32; color:#FFF;'>DLP FORTI_DLP</span>
                        </h4>
                    </div>
                </div>
            </div>
                        ...
                        <div class="tab-content text-muted">
                            ...
                            <div class="tab-pane active" id="tab_nuevos" role="tabpanel">
                                <div class="card card-body">
                                    <table id="table_proyectos_nuevos_funcional_services" style="text-align: center; width: 100%;">
                            ...
                            <div class="tab-pane" id="tab_abiertos" role="tabpanel">
                                <div class="tab-pane active" id="tab_nuevos" role="tabpanel">
                                    <div class="card card-body">
                                        <table id="table_proyectos_abiertos_functional_services"
                            ...
                            <div class="tab-pane" id="tab_realizados" role="tabpanel">
                                <div class="tab-pane active" id="tab_nuevos" role="tabpanel">
                                    <div class="card card-body">
                                        <table id="table_proyectos_realizados_functional_services"
                                            style="text-align: center; width: 100%;">
                                            <thead style="text-align: center;">
                                                <tr style="text-align: center;">
                                                    <th style="width: 300px;text-align: center;">TITULO</th>
