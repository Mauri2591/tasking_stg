            ...
            <div class="row">
                <div class="col-12">
                     <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-light">
                        <h4 class="mb-sm-0"><span class="badge" style='background-color:#8F6B32; color:#FFF;'>FUNCTIONAL SERVICES</span><span class="badge mx-1" style='background-color:#8F6B32; color:#FFF;'>DLP FORTRA</span>
                        </h4>
                    </div>
                </div>
            </div>
