            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">
                            <span class="badge bg-dark text-light">SOC</span>
                        </h4>
                    </div>
                </div>
            </div>
                            ...
                            <div class="tab-content text-muted">
                                ...
                                <div class="tab-pane active" id="tab_nuevos" role="tabpanel">
                                    <div class="card card-body">
                                        <table id="table_proyectos_nuevos_soc" class="table text-center w-100">
                                            <thead>
                                                <tr>
                                                    <th>TITULO</th>
                                                    <th>INICIO</th>
                                ...
                                <div class="tab-pane" id="tab_abiertos" role="tabpanel">
                                    <div class="card card-body">
                                        <table id="table_proyectos_abiertos_soc" class="table text-center w-100">
                                            <thead>
                                                <tr>
                                                    <th>CLIENTE</th>
                                                    <th>INICIO</th>
                                ...
                                <div class="tab-pane" id="tab_realizados" role="tabpanel">
                                    <div class="card card-body">
                                        <table id="table_proyectos_realizados_soc" class="table text-center w-100">
                                            <thead>
                                                <tr>
                                                    <th>CLIENTE</th>
                                                    <th>INICIO</th>
