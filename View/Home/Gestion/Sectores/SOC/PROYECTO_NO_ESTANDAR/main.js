$(document).ready(function () {
    tabla = $("#table_proyectos_nuevos_eh_soc").dataTable({
        ...
        "ajax": {
            ...
            data: {
                sector_id: 2, // soc
                cat_id: 37, //proyectos no estandar
                estados_id: 1 //nuevos
            },
            error: function (e) {}
        },
    ...
    tabla = $("#table_proyectos_cerrados_calidad_eh_soc").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
...
function cambiar_a_borrador(id_proyecto_gestionado) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#table_proyectos_nuevos_eh_soc')) {
            ...
            setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#table_proyectos_abiertos_eh_soc')) {
