$(document).ready(function () {
    tabla = $("#table_proyectos_nuevos_soc_incident_response").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
        ...
        "ajax": {
            ...
            dataType: "json",
            data: {
                sector_id: 5, // incident response
                cat_id: 26, //incident_response 
                estados_id: 1 //nuevos
            },
            error: function (e) {}
        },
    ...
    tabla = $("#table_proyectos_abiertos_soc_incident_response").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_realizados_soc_incident_response").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_cerrados_soc_incident_response").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
...
function cambiar_a_borrador(id_proyecto_gestionado) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#table_proyectos_abiertos_soc_incident_response')) {
