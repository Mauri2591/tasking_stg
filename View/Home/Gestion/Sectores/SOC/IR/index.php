                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-light">
                        <h4 class="mb-sm-0"><span class="badge bg-dark text-light">SOC</span><span
                                class="badge text-light mx-1" style="background-color:#299cdb">INCIDENT RESPONSE</span>
                        </h4>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card-body">
                        <ul class="nav nav-pills arrow-navtabs nav-success bg-light mb-3" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#tab_cerrados" role="tab">
                                    <span class="d-block d-sm-none"><i class="mdi mdi-email"></i></span>
                        ...
                        <div class="tab-content text-muted">
                            <div class="tab-pane active" id="tab_nuevos" role="tabpanel">
                                <div class="card card-body">
                                    <table id="table_proyectos_nuevos_soc_incident_response"
                            ...
                            <div class="tab-pane" id="tab_abiertos" role="tabpanel">
                                <div class="card card-body">
                                    <table id="table_proyectos_abiertos_soc_incident_response"
                                        style="text-align: center; width: 100%;">
                                        <thead style="text-align: center;">
                                            <tr style="text-align: center;">
                                                <th style="width: 300px;text-align: center;">TITULO</th>
                            ...
                            <div class="tab-pane" id="tab_realizados" role="tabpanel">
                                <div class="card card-body">
                                    <table id="table_proyectos_realizados_soc_incident_response"
                                        style="text-align: center; width: 100%;">
                                        <thead style="text-align: center;">
                                            <tr style="text-align: center;">
                                                <th style="width: 300px;text-align: center;">TITULO</th>
                            ...
                            <div class="tab-pane" id="tab_cerrados" role="tabpanel">
                                <div class="card card-body">
                                    <table id="table_proyectos_cerrados_soc_incident_response"
                                        style="text-align: center; width: 100%;">
                                        <thead style="text-align: center;">
                                            <tr style="text-align: center;">
                                                <th style="width: 300px;text-align: center;">TITULO</th>
