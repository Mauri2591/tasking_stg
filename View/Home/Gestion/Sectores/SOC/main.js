...
function cambiar_proy_soc_desde_calidad_pentest(id_proyecto_gestionado) {
    Swal.fire({
        icon: "info",
        ...
        if (result.isConfirmed) {
            $.post("../../../../../Controller/ctrProyectos.php?proy=update_estado_proy_soc", { id: id_proyecto_gestionado, estados_id: 14 },
