$(document).ready(function () {
    tabla = $("#table_proyectos_nuevos_eh_edr").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_abiertos_eh_edr").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_realizados_eh_edr").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_cerrados_calidad_eh_edr").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
...
function cambiar_a_borrador(id_proyecto_gestionado) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#table_proyectos_nuevos_eh_edr')) {
                    $('#table_proyectos_nuevos_eh_edr').DataTable().ajax.reload(null, false);
                    $('#table_proyectos_borrador').DataTable().ajax.reload(null, false);
                }
            }, 500);

            setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#table_proyectos_abiertos_eh_edr')) {
                    $('#table_proyectos_abiertos_eh_edr').DataTable().ajax.reload(null, false);
                    $('#table_proyectos_borrador').DataTable().ajax.reload(null, false);
                }
            }, 500);
...
function cambiar_a_realizado(id_proyecto_gestionado) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $('#table_proyectos_abiertos_eh_edr').DataTable().ajax.reload(null, false);
            $('#table_proyectos_realizados_eh_edr').DataTable().ajax.reload(null, false);
        }
    })
}