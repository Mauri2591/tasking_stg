$(document).ready(function () {
    tabla = $("#table_proyectos_nuevos_sase_navegacion_segura").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_abiertos_sase_navegacion_segura").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_realizados_sase_navegacion_segura").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_cerrados_calidad_sase_navegacion_segura").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
...
function cambiar_a_borrador(id_proyecto_gestionado) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#table_proyectos_abiertos_sase_navegacion_segura')) {
                    $('#table_proyectos_abiertos_sase_navegacion_segura').DataTable().ajax.reload(null, false);
                    $('#table_proyectos_borrador').DataTable().ajax.reload(null, false);
                }
            }, 500);

            setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#table_proyectos_nuevos_sase_navegacion_segura')) {
                    $('#table_proyectos_nuevos_sase_navegacion_segura').DataTable().ajax.reload(null, false);
                    $('#table_proyectos_borrador').DataTable().ajax.reload(null, false);
                }
            }, 500);
            Swal.fire({
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            Swal.fire({
              ...
              setTimeout(() => {
                if ($.fn.DataTable.isDataTable('#table_proyectos_realizados_sase_navegacion_segura')) {
                    $('#table_proyectos_realizados_sase_navegacion_segura').DataTable().ajax.reload(null, false);
                    $('#table_proyectos_abiertos_sase_navegacion_segura').DataTable().ajax.reload(null, false);
                }
            }, 500);
        }
