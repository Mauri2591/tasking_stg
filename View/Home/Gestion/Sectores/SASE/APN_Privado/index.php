                ...
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-light">
                        <h4 class="mb-sm-0"><span style="background-color:#299cdb" class="badge text-light">SASE</span><span
                                class="badge text-light mx-1" style="background-color:#299cdb">APN Privado</span>
                        </h4>
                    </div>
                </div>
            </div>
                        ...
                        <div class="tab-content text-muted">
                            <div class="tab-pane active" id="tab_nuevos" role="tabpanel">
                                <div class="card card-body">
                                    <table id="table_proyectos_nuevos_sase_apn_privado" style="text-align: center; width: 100%;">
                            ...
                            <div class="tab-pane" id="tab_abiertos" role="tabpanel">
                                <div class="card card-body">
                                    <table id="table_proyectos_abiertos_sase_apn_privado" style="text-align: center; width: 100%;">
                                        <thead style="text-align: center;">
                                            <tr style="text-align: center;">
                                                <th style="width: 300px;text-align: center;">TITULO</th>
                                                <th style="width: 300px;text-align: center;">INICIO</th>
                            ...
                            <div class="tab-pane" id="tab_realizados" role="tabpanel">
                                <div class="card card-body">
                                    <table id="table_proyectos_realizados_sase_apn_privado" style="text-align: center; width: 100%;">
                                        <thead style="text-align: center;">
                                            <tr style="text-align: center;">
                                                <th style="width: 300px;text-align: center;">TITULO</th>
                                                <th style="width: 300px;text-align: center;">INICIO</th>
                            ...
                            <div class="tab-pane" id="tab_cerrados_calidad" role="tabpanel">
                                <div class="card card-body">
                                    <table id="table_proyectos_cerrados_calidad_sase_apn_privado"
