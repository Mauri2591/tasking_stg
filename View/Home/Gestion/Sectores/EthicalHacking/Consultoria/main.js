$(document).ready(function () {
    tabla = $("#table_proyectos_nuevos_eh_consultoria").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_abiertos_eh_consultoria").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_realizados_eh_consultoria").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    tabla = $("#table_proyectos_cerrado_calidad_eh_consultoria").dataTable({
        "aProcessing": true,
        "aServerSide": true,
        dom: 'Bfrtip',
        "searching": true,
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            setTimeout(() => {
                ...
                if ($.fn.DataTable.isDataTable('#table_proyectos_abiertos_eh_consultoria')) {
                    $('#table_proyectos_abiertos_eh_consultoria').DataTable().ajax.reload(null, false);
                }
                if ($.fn.DataTable.isDataTable('#table_proyectos_nuevos_eh_consultoria')) {
                    $('#table_proyectos_nuevos_eh_consultoria').DataTable().ajax.reload(null, false);
                }
            }, 500);
...
function cambiar_a_realizado(id_proyecto_gestionado) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $('#table_proyectos_abiertos_eh_consultoria').DataTable().ajax.reload(null, false);
            $('#table_proyectos_realizados_eh_consultoria').DataTable().ajax.reload(null, false);
        }
    })
}