...
?>
    ...
    case 'get_proyectos_consulting':
        $datos = $proyecto->get_proyectos_consulting($_POST['sector_id'], $_POST['cat_id'], $_POST['estados_id']);
        $data = array();
        $colores = array(
            "ETHICAL HACKING" => "bg-warning text-dark",
            "SOC" => "bg-dark text-light",
                    ...
                    <div style="display:flex">
                        ...
                        if ($val['envio_correo_cliente'] == 'SI') {
                            if ($val['status_envio'] == 'OK') {
                                $icono_correo_enviado = '<i class="ri-mail-send-line fs-18 text-success" title="Correo enviado al cliente" style="font-size:1rem;"></i>';
