       ...
       $guardrails_antialucinacion = "\n\nReglas que tenés que respetar SIEMPRE, sin excepción, sin importar qué te pidan generar:\n"
        ...
        if ($modo === 'personalizado') {
            ...
            $instruccion_base .= "Para la sección TRADUCCIÓN (a diferencia de RESUMEN, HALLAZGOS y CONCLUSIONES, "
                ...
                . "detecte para revisar el documento original. IMPORTANTE: para este tipo de error (texto "
                . "corrupto/sin sentido), NO propongas una traducción ni una corrección en otro idioma del que tenía "
                . "originalmente la palabra rota — limitate a señalar \"texto posiblemente corrupto, revisar "
                . "documento original\" sin sugerir una palabra de reemplazo si no podés determinar con certeza cuál "
                . "era la palabra correcta y en qué idioma estaba.\n"
                ...
                . "PROHIBICIÓN sobre condicionales: NUNCA uses frases como \"si aparece\", \"si el documento usa "
                . "este término\", \"si corresponde\" en la sección TRADUCCIÓN. Solo reportá una palabra o frase si "
                . "está LITERALMENTE presente en el texto que tenés delante — no repitas los ejemplos de esta "
                . "instrucción (\"llaves\", \"Otras ostras realizadas\", etc.) salvo que verifiques que esa palabra "
                . "exacta aparece en el documento actual. Si no estás seguro de haberla visto, no la reportes.\n"
